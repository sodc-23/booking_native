...
export default class PackageBookingInput extends PureComponent {
    state = {
        items: []
    }
    ...
    initItems(props) {
        ...
        let items = [
            ...
            { title: 'Address1', value: address1, isMandatory: true, type:'TEXT', errorMsg:'Please enter address.', ref1:'address1'},
            ...
            { title: 'Zip Code', value: zipCode, isMandatory: true, type:'TEXT', errorMsg:'Please input zip code.', ref1:'zipCode'},
            { title: 'Cell Phone', value: {code:cellPhoneCode, number:cellPhone}, type:'PHONE_NUMBER', isMandatory:true, errorMsg:value=>value.number.isValidPhoneNumber(), pointer:'cellPhone'},

...
export default CruiseItem = ({ image, title, rating, info, location, before, current, desc, hasSpecialDeal, specialDealDescription = '', onPress, ratingInfo, language:{T3} }) => (
    <TouchableOpacity onPress={() => onPress()} style={styles.itemContainer}>
        ...
        <View style={styles.centerItemContainer}>
            ...
            />
            <Text style={styles.smallOrange}>{info}</Text>
...
CruiseItem.defaultProps={
    ...
    rating:4, 
    review:null, 
    location:'Dubai-Subway Station', 
    before: 400, 
    current: 'SAR 200', 
    desc:'No Payment', 
    hasSpecialDeal:null, 
    specialDealDescription:'', 
    info:'5 Night Bahamas Cruise'
}

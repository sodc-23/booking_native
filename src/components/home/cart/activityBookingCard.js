...
export default class BookingCard extends PureComponent {
    ...
    render() {
        ...
        let activityDate = moment(cart.data.dateInfo.startDate).format('DD-MM-YYYY hh:mm A')
            ...
            <View style={styles.cardContainer}>
                ...
                <View style={styles.content}>
                    ...
                    <View style={styles.locationContainer}>
                        ...
                        <Text style={styles.location}>Activity Date: <Text style={styles.boldText}>{activityDate}</Text></Text>
                    </View>
                    <View style={styles.locationContainer}>

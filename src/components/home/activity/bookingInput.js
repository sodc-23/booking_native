...
export default class ContactInput extends PureComponent {
    ...
    initItems(props) {
        ...
        let items = [
            ...
            { title: 'Home Phone', value: {code:homePhoneCode, number:homePhone}, type:'PHONE_NUMBER', pointer:'homePhone', isMandatory:true, errorMsg:value=>value.number.isValidPhoneNumber()},
        ]
        this.setState({ items })
    }

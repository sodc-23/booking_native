...
class FloatLabelTextField extends Component {
  ...
  withBorder() {
    if (!this.props.noBorder) {
      return this.props.isError?styles.withErrBorder:styles.withBorder;
    }
  }
    ...
    return ( 
      <View style={[styles.container,this.props.containerStyle]}>
        <View style={styles.viewContainer}>
          ...
          <View style={[styles.fieldContainer, this.withBorder(), this.props.innerStyle]}>
            <FloatingLabel visible={this.state.text}>
              <Text style={[styles.fieldLabel, {color:this.props.placeholderTextColor}]}>{this.placeholderValue()}</Text>
            </FloatingLabel>
